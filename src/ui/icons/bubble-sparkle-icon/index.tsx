...
export interface BubbleSparkleIconProps extends React.SVGProps<SVGSVGElement> {
  withAccessibility?: boolean
}

export const BubbleSparkleIcon = (props: BubbleSparkleIconProps) => {
  ...
  if (withAccessibility) {
    return <AccessibleIcon label="Bubble Sparkle icon">{svg}</AccessibleIcon>
  }
